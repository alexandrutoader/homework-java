...
import com.siit.homework.course11.ibm.streams.tutorial.exercise5.thirdpartyplugin.CloudScrobblingMusicLibrary;
import com.siit.homework.course11.ibm.streams.tutorial.exercise5.thirdpartyplugin.LocalFilesystemMusicLibrary;
import com.siit.homework.course11.ibm.streams.tutorial.exercise5.thirdpartyplugin.UserRatedLocalFilesystemMusicLibrary;
import com.siit.course11.ibm.streams.tutorial.util.FeatureMatchers;
import com.siit.course11.ibm.streams.tutorial.util.HasConcreteMethod;
...
//        Until the sortedByArtist method is added to MusicLibrary, there will be a compiler error.
        assertThat(library.sortedByArtist(library.allSongs()), containsSongsBy("Bob Dylan", "Creedence Clearwater Revival",
